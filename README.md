...
The Blue LED is used as status indicator:
  ...
  - Long on (800 ms) - short off (200 ms) flashing (1 sec period): Treadmill connected, waiting for Watch
  - Short on (200 ms) - long off (800 ms) flashing (1 sec period): Watch connected, waiting for Treadmill
